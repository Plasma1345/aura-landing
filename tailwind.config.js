  	...
  	extend: {
  		...
  		animation: {
			...
			backgroundImage: {
				...
				'gradient-primary': 'linear-gradient(135deg, #667eea, #764ba2)',  // Keep this from the original template
				'hero-gradient': 'radial-gradient(ellipse 80% 50% at 50% -20%, hsl(var(--accent) / 0.1), transparent)', // Custom hero gradient
